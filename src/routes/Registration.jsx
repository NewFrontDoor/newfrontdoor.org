		...
		<div className="registration-wrapper">
			<div className="registration-overlay">
				<div className="site-wrapper site-wrapper-padding">
					<h1>Events Registration Module</h1>
					<section>
						...
						<p>There are a number of event registration systems available, but come with a number of drawbacks. You might have experienced one or more of these:</p>
						<ul>
							...
							<li>You're tied into a subscription service, your registration details are only available online, the format of your registration spreadsheet is not changeable.</li>
