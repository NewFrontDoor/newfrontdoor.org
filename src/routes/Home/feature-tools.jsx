...
export const FeaturedTools = props => (
	<Featured name="tools" className="featured-third featured-light">
		<div className="site-wrapper site-wrapper-padding">
			...
			<section className="description">
				...
				<p className="lead">The core product of Vision 100 IT isn't
					<em>just your website</em>
					- it's our
					<em>philosophy.</em>
				</p>
				...
				<p>We're eager to ensure that you're equipped to make the most of these tools as the web evolves over time. We won't just build you a website, mailing lists and collaborative storage solutions, but we'll</p>
				<ul>
				...
				<p>Although we think this ecosystem is fantastic, selecting our tools over years of experience, your needs may vary. If you already have some solutions sorted, no problem! We'll work with you as best as we can to
					<em>ensure you're being as effective as possible.</em>
				</p>
