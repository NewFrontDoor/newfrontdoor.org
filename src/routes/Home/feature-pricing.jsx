	...
	<Featured name="pricing" className="featured-fifth featured-light">
		<div className="site-wrapper site-wrapper-padding">
			...
			<blockquote className="lead">
				...
				that will keep you
				<em>engaged with your IT</em>, rather than a product that is merely set and forget. If giving our services to you for free achieves that goal, we'll do it.
			</blockquote>

			<p className="lead">
				<em>A few extras might have
					<strong>some</strong>
					costs
				</em>
			</p>

			<p>We do have some services that will carry a cost, but we think that if you've got the right people on the ground, and make good use of our documentation, you'll be fine. Some of our products carry a cost as well. Our registration payment system is a 'premium' product for which we charge a small extra fee</p>
			<p className="lead">
				<em>Consultation services</em>
			</p>

			<p>In addition to our normal customer services, we can provide full blown consultation services to help you smoothly transition your church into electronic administration. For more details about our consultation services,
