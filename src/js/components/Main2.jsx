...
<h3><a href="#">Meet the team.</a></h3>
				...
				<div className="featured-fourth featured-dark" id="events">
					<div className="site-wrapper site-wrapper-padding">
						...
						<section>
							<div>
								<div className="text-slab"><em>At the heart of Vision 100 IT is our events and training</em></div>
							</div>
						</section>
					</div>
				</div>
				<div className="featured-fifth featured-light" id="pricing">
					<div className="site-wrapper site-wrapper-padding">
						...
						<section>
							...
							<p>This is our rationale: <blockquote>We want to focus on providing you <em> services and methodology</em> that will keep you <em>engaged with your IT</em>, rather than a product that you'll set aside. If giving our services to you for free achieves that goal, we'll do it.</blockquote></p>
