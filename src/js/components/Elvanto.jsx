...
export const Elvanto = () => (
	...
	<div className="elvanto-overlay">
		<div className="site-wrapper site-wrapper-padding">
			<h1>Elvanto Church Management System</h1>
			<section>
				...
				<p>We have searched through a number of Church Management Systems, and have come to the conclusion that Elvanto offers the best flexibility of features relative to it's cost. Elvanto integrates well into our ecosystem, and fits the Vision 100 IT philosophy of use. What's more, Elvanto is an Australian company, so support and featured webcasts are in our timezone! We so believe in the product Elvanto offers that Vision 100 IT has partnered with Elvanto to train client churches who choose to use this system.</p>

				<h3>Does that mean you will only support users of Elvanto?</h3>
				<p>Elvanto is the system that we're most familiar with, but we also have had extensive experience with Church Community Builder and recommend it as an alternative if Elvanto does not fit your requirements. If you are a V100IT client, we will do our best to support you with whichever CMS you choose to use in your context.</p>

				<h3>How do I get started?</h3>
				<p>The best thing to do would be to be in touch through our <a href="/#join">Contact Form</a> if you wish to come on board, or if you are already a V100IT client, then let us know you'd like to get going with Elvanto through the <a href="/feature">Feature Request form</a>.</p>
