	...
	<div className="podcasting-overlay">
		<div className="site-wrapper site-wrapper-padding">
			...
			<section>
				...
				<p>This is why Vision 100 IT offers podcasting as a core feature of our websites - and for your admin staff, once the system is set up it's as simple as uploading the file, and the rest is handled automatically.</p>
				...
				<p>If you're interested in having podcasting added to your website, let us know through the feature request form. If you currently don't have a V100IT hosted website, but are interested in podcasting on your own page, we'd be happy to let you know what you need to consider to set it up for yourself.</p>
			</section>
		</div>
	</div>
	</div>
