	...
	render() {
		return (
			<div className="site-wrapper">
				<h1>Control page</h1>
				<div><p>A mockup control panel for easy implementation of site features.</p><p>This would likely require implementation of a database of some sort, which is currently not available.</p></div>
				<hr />
				<form className="">
