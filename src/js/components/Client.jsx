										...
										<section className="post">
												<header className="post-header">
														...
														<div className="post-meta">
																...
																<span className="post-date">3rd March, 2015</span>
												...
												<div className="post-body">
														...
														<div className="post-content">
																<p>As you can probably tell, Vision 100 IT now has it's own special home on the web. If you're not viewing this post in situ, head to
																		<a href="#">Vision 100 IT</a>
																		and check it out
																</p>
																...
																<p>Check it out at
																		<a href="#">Vision 100 IT website placeholder!</a>
																</p>
														</div>
												</div>
										</section>
								...
								<section className="posts">
										<section className="post">
												...
												<div className="post-body">
														...
														<p>Unsplash is a great resource for visual imagery, particularly as it focuses on nature photography, and all images on the site are high resolution and able to be used for whatever you want.
														We're particularly impressed by the fact that these images often leave plenty of space to put text (like Sermon Series titles), so it's well worth a look.</p>
														<p>Check it out at
										...
										<section className="post">
												...
												<div className="post-body">
														...
														<p>If you want us to roll this out for you when your events are happening, let us know at
										...
										<section className="post">
												...
												<div className="post-body">
														...
														<p>If you want to know any more about what we're trying to do with Vision 100 IT, or for any other reason, let us know at
																<a href="mailto:it@vision100.org">it@vision100.org</a>.
														</p>
												</div>
										</section>
